...
import { dataset } from './weather.ts';
...
const valueFormatter = (value) => `${value}EA`;

const chartSetting = {
  yAxis: [
    {
      label: 'จํานวน Certificates (EA)',
    },
  ],
  series: [{ dataKey: 'seoul', label: 'ข้อมูล Certificates ทั้งหมดของ ศซว.ทอ.', valueFormatter }],
  height: 300,
  sx: {
...
export default function TickPlacementBars() {
  ...
  return (
      <Box marginLeft="0%" sx={{width: '70%',height: '50%',borderRadius:'30px', border: '1px solid black',paddingLeft: '20px',}}>
      {/* <TickParamsSelector
